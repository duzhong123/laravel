...
@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<input type="text" class="form-control" id="firstname"  name="goods_order" value="{{$goods->goods_order}}"
				   placeholder="请输入单号">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<input type="text" class="form-control" id="firstname"  name="goods_num" value="{{$goods->goods_num}}"
    ...
    <div class="form-group">
		...
		<div class="col-sm-7">
			...
			<b style="color:red">{{$errors->first('care_id')}}</b>
		</div>
	</div>
    <div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-7">
			<textarea type="text" class="form-control" id="firstname"  name="goods_desc" value="{{$goods->goods_desc}}"></textarea>
		</div>
	</div>
    <div class="form-group">
